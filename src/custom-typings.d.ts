...
declare var CLOUDSIM_VERSION: string;
declare var CLOUDSIM_HOST: string;
declare var SUBT_PORTAL_URL: string;
declare var AWS_GZ_LOGS_BUCKET: string;
declare var System: SystemJS;

declare var AUTH0_AUDIENCE: string;
declare var AUTH0_CLIENT_DOMAIN: string;
declare var AUTH0_CLIENT_ID: string;
declare var AUTH0_LOGOUT_REDIRECT: string;
declare var AUTH0_REDIRECT: string;
declare var AUTH0_SCOPE: string;
...
interface GlobalEnvironment {
  ...
  API_VERSION: string;
  API_HOST: string;
  CLOUDSIM_VERSION: string;
  CLOUDSIM_HOST: string;
  SUBT_PORTAL_URL: string;
  AWS_GZ_LOGS_BUCKET: string;
