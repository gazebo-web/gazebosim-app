...
describe("CollectionService", () => {
  ...
  const testCollectionListJson = [testCollectionJsonA, testCollectionJsonB];
  ...
  it("should get the list of collections", () => {
    ...
    service.getCollectionList().subscribe((paginatedCollection) => {
  ...
  it("should get the list of collections with partial search", () => {
    ...
    service
      .getCollectionList({ search: "test" })
      .subscribe((paginatedCollection) => {
        expect(paginatedCollection.collections).toEqual(testCollectionList);
      });
  ...
  it("should get the list of collections that can be extended by an user", () => {
    ...
    service.getCollectionExtensibleList().subscribe((paginatedCollection) => {
      expect(paginatedCollection.collections).toEqual(testCollectionList);
    });
  ...
  it("should get the list of extensible collections along with a partial search", () => {
    ...
    service
      .getCollectionExtensibleList({ search: "partial" })
      .subscribe((paginatedCollection) => {
        expect(paginatedCollection.collections).toEqual(testCollectionList);
      });
  ...
  it("should get the list of collections owned by an entity", () => {
    ...
    service.getOwnerCollectionList(owner).subscribe((paginatedCollection) => {
  ...
  it("should get a single collection", () => {
    ...
    service.getCollection(owner, name).subscribe((collection) => {
  ...
  it("should get the list of models of a collection", () => {
    ...
    service.getCollectionModels(owner, name).subscribe((paginatedModels) => {
  ...
  it("should get the list of worlds of a collection", () => {
    ...
    service.getCollectionWorlds(owner, name).subscribe((paginatedWorlds) => {
  ...
  it("should get the collections that have an asset", () => {
    ...
    service.getAssetCollections(resource).subscribe((paginatedCollection) => {
      expect(paginatedCollection.collections).toEqual(testCollectionList);
    });
  ...
  it("should create a collection", () => {
    ...
    service.createCollection(testCollectionJsonA).subscribe((collection) => {
      expect(collection).toEqual(testCollectionA);
    });
  ...
  it("should get the next page of a paginated collection", () => {
    ...
    service.getNextPage(paginatedCollection).subscribe((response) => {
  ...
  it(`should parse the next pagination url if it's present in the headers`, () => {
    ...
    const header: HttpHeaders = new HttpHeaders({
      link: '</collections?page=2>; rel="next"',
    });
    const testUrl: string = `${service.baseUrl}/collections`;
