...
describe("OrganizationService", () => {
  ...
  const testOrganizationA: Organization = new Organization(
    testOrganizationJsonA,
  );
  const testOrganizationB: Organization = new Organization(
    testOrganizationJsonB,
  );
  const testOrganizationList: Organization[] = [
    testOrganizationA,
    testOrganizationB,
  ];
  ...
  it("should get the list of organizations", () => {
    ...
    service.getPublicOrganizations().subscribe((paginatedOrganizations) => {
      expect(paginatedOrganizations.organizations).toEqual(
  ...
  it("should get a single organization", () => {
    ...
    service.getOrganization(orgName).subscribe((organization) => {
  ...
  it("should create an organization", () => {
    ...
    service
      .createOrganization(testOrganizationJsonA)
  ...
  it("should add a user to an organization", () => {
    ...
    service
      .addUserToOrganization(testOrganizationA, testUser.username, "member")
      .subscribe();
