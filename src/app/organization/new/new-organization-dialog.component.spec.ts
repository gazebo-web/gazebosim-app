...
describe("NewOrganizationDialogComponent", () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      declarations: [NewOrganizationDialogComponent],
      imports: [
        MatDialogModule,
  ...
  it("should build the new organization form", () => {
    ...
    expect(component.newOrganizationForm.controls["plan"].value).toBe(
      component.planOptions[0],
    );
  });
  ...
  it("should return the correct error for the organization name", () => {
    ...
    expect(error).toBe(
      "This organization already exists. Please use a different name",
    );
