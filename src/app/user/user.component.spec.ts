...
import { MatTabsModule, MatCardModule, MatIconModule, MatSnackBarModule } from '@angular/material';
...
describe('UserComponent', () => {
  ...
  it(`should get the user's models on the OnInit lifecycle hook`, async(() => {
  ...
  it(`should get the user's liked models on the OnInit lifecycle hook`, async(() => {
    const snackBar = component.snackBar;
  ...
  it(`should get the user's worlds on the OnInit lifecycle hook`, async(() => {
    const snackBar = component.snackBar;
  ...
  it(`should get the user's liked worlds on the OnInit lifecycle hook`, async(() => {
    const snackBar = component.snackBar;
  ...
  it(`should get the user's collections on the OnInit lifecycle hook`, async(() => {
    const snackBar = component.snackBar;
  ...
  it(`should load the next page of liked models`, async(() => {
  ...
  it(`should load the next page of liked worlds`, async(() => {
