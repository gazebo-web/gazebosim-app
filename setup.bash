...
# Auth0 related.
export AUTH0_CLIENT_ID="rcfGFzR1tyAOFHfA8LeDZpFu4teBy8d7"
export AUTH0_CLIENT_DOMAIN="gazebosim-staging.us.auth0.com"
export AUTH0_AUDIENCE="https://staging-fuel.gazebosim.org"
#export AUTH0_REDIRECT="https://staging.gazebosim.org/callback"
#export AUTH0_LOGOUT_REDIRECT="https://staging.gazebosim.org/callback"
